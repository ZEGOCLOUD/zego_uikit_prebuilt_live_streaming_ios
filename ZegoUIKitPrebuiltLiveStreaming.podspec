#
#  Be sure to run `pod spec lint ZegoUIKitPrebuiltLiveStreaming.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "ZegoUIKitPrebuiltLiveStreaming SDK for iOS by ZEGO"
  ...
  spec.source       = { :git => "https://github.com/ZEGOCLOUD/zego_uikit_prebuilt_live_streaming_ios.git", :tag => "v#{spec.version.to_s}"}
  ...
  spec.dependency 'ZegoUIKit','>= 1.8.2'
