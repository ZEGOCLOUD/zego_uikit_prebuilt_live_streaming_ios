//
//  ZegoLiveStreamAuthorizedCheck.swift
//  ZegoUIKitPrebuiltLiveStreaming
//
//  Created by zego on 2022/11/7.
//
...
class ZegoLiveStreamAuthorizedCheck: NSObject {
    ...
    static func showCameraUnauthorizedAlert(_ text: ZegoTranslationText,viewController: UIViewController, okCompletion: @escaping () -> Void, cancelCompletion: @escaping () -> Void) {
        showAlert(text, .cameraAlter, viewController, okCompletion: okCompletion, cancelCompletion: cancelCompletion)
    }
